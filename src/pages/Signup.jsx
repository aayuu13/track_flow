    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-100 p-4">
      <div className="bg-white p-12 rounded-2xl shadow-lg w-full max-w-md border border-slate-200">
        <div className="text-center mb-12">
          ...
          <p className="text-slate-500 text-sm font-medium tracking-wide">CREATE YOUR ACCOUNT</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div>
            <label className="block text-slate-700 font-semibold text-sm mb-2">Business Name</label>
            <input
              type="text"
              value={businessName}
